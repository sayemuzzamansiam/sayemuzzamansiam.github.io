    ...
    Alpine.data('neuralPortfolio', () => ({
        ...
        renderGraph() {
            ...
            const nodes = [
                ...
                { id: 'r1', name: 'Robust Fault Diagnosis in PV Systems', layer: 2, type: 'Research', color: '#bc00ff', description: 'Multi-Signal Deep Learning Approach with Res-CNNs and GRUs for Enhanced Reliability in Photovoltaic Systems.', link: 'https://scholar.google.com/citations?view_op=view_citation&hl=en&user=6eadvpUAAAAJ&citation_for_view=6eadvpUAAAAJ:2osOgNQ5qMEC', tech: 'IEEE ICCIT 2025', visible: false, x: width / 1.8, y: height / 2 - 220 },
                { id: 'r2', name: 'ML for Future-Proof Smart Grids', layer: 2, type: 'Research', color: '#bc00ff', description: 'A Framework for Predicting Stability and Efficiency in Smart Grid Systems.', link: 'https://scholar.google.com/citations?view_op=view_citation&hl=en&user=6eadvpUAAAAJ&citation_for_view=6eadvpUAAAAJ:9yKSN-GCB0IC', tech: 'IEEE ICCIT 2025', visible: false, x: width / 1.8, y: height / 2 - 160 },
                { id: 'r3', name: 'XAI for Pneumonia Detection', layer: 2, type: 'Research', color: '#bc00ff', description: 'Explainable Artificial Intelligence for Deep Learning-Based Detection of Pneumonia in Chest X-ray Images.', link: 'https://scholar.google.com/citations?view_op=view_citation&hl=en&user=6eadvpUAAAAJ&citation_for_view=6eadvpUAAAAJ:u5HHmVD_uO8C', tech: 'Springer Nature 2025', visible: false, x: width / 1.8, y: height / 2 - 100 }
            ];
